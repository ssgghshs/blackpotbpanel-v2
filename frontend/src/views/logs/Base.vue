<template>
  <div class="settings-container">
    <nav class="horizontal-menu">
      <ul>
        <li><router-link to="/logs/systemlog">{{ t('systemLogs') }}</router-link></li>
        <li><router-link to="/logs/access">{{ t('access') }}</router-link></li>
        <li><router-link to="/logs/operation">{{ t('operationLog') }}</router-link></li>
        <li><router-link to="/logs/loginLogs">{{ t('loginLogs') }}</router-link></li>
      </ul>
    </nav>
    <router-view />
  </div>
